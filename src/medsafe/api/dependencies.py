...
from medsafe.resolution.combinations import CombinationIndex
...
class EngineState:
    ...
    matcher: Matcher
    combinations: CombinationIndex = field(default_factory=CombinationIndex)
...
def get_combinations(request: Request) -> CombinationIndex:
    return get_engine_state(request).combinations
...
CombinationsDep = Annotated[CombinationIndex, Depends(get_combinations)]
